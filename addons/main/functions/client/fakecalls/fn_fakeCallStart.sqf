/*
    ...
    fakeCallAccept is executed by player by calling a prepped phone number
...

{
    ...
    _receiverPhoneObject setVariable ["grad_telephone_dontRing", true, true]; // todo: clean up
    ...
    [{
        ...
        params ["_dialing", "_callerPhoneObject", "_receiverPhoneObject", "_callerNumber", "_receiverNumber"];
            ...
            if ([_receiverPhoneObject, "idle"] call grad_telephone_fnc_callGetStatus) then {
                ...
                [_receiverPhoneObject] remoteExec ["grad_telephone_fnc_fakeCallRinging", 2];
